...
**Load data**
```{r}
behance = read.csv('../data/sampled-graph/behance-users.csv')
...
measures<-behance[, (names(behance) %in% c(drops))] # only numeric variables
summary(measures)
```
...
```{r}
fit<-update(fitnb, .~. -collection_counts-collection_item_counts-from_egypt-has_photography
