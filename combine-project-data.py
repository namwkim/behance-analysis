...
prop_file = csv.reader(open("behance-project-props.csv", 'r'))
...
print 'add properties to projects'
proj_file = csv.reader(open("behance-projects-raw.csv", 'r'))
proj_header = next(proj_file)

output_file = csv.writer(open('behance-projects.csv', 'wb'))
